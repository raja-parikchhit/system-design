...
|---|---|---|
| [Option A](./option-a-no-queue.md) | **Table-as-source-of-truth, no queue** | Teams optimizing for correctness, simplicity, and operational minimalism |
| [Option B](./option-b-with-queue.md) | **Table + notification queue in hybrid mode** | Teams needing push latency at scale with a durable broker already in place |
| [Option C](./option-c-orchestrator-locks.md) | **Orchestrator + distributed locks + event log** | Multi-region, multi-tenant, workflow-adjacent schedulers at 1M+ runs/sec |
